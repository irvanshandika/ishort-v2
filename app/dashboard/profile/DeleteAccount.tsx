...
import { db, auth } from "@/src/lib/firebase"; // Firebase imports
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-md">
          ...
          <DialogFooter className="flex-col-reverse sm:flex-row gap-2">
            ...
            <Button type="button" variant="destructive" disabled={confirmText !== "delete" || isDeleting} onClick={handleDeleteAccount} className="w-full sm:w-auto">
