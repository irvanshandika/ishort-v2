...
const plans = [
  ...
  },
  {
    ...
    features: ["1,000 links per month", "Advanced analytics", "Custom domains", "Password protection", "Team collaboration (5 members)", "Priority support"],
  ...
  },
  {
    ...
    features: ["10,000 links per month", "Premium analytics & reporting", "Multiple custom domains", "Advanced security features", "Team collaboration (unlimited)", "Dedicated support", "White-label options"],
